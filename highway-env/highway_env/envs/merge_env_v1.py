...
class MergeEnv(AbstractEnv):
    ...
    def default_config(cls) -> dict:
        ...
        config.update({
            ...
            "duration": 20,  # time step changed value from 20 to 60
    ...
    # def print_vechile_coordinates(self) -> None:
    #     print(Vehicle.)
    ...
    def _make_vehicles(self, num_CAV=14, num_HDV=13) -> None:
        """
        ...
        #for _ in range(num_HDV - num_HDV // 2): original 
